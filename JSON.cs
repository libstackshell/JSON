...
namespace ScriptStack
{
    ...
    public class JSON : Model
    {
        ...
        public JSON()
        {
            ...
            routines.Add(new Routine((Type)null, "json.parse", (Type)null, "Erstelle ein JSON Objekt aus einem String."));
            routines.Add(new Routine((Type)null, "json.get", (Type)null, (Type)null, "Lese ein JSON Objekt als JSON-Path."));
            routines.Add(new Routine((Type)null, "json.set", (Type)null, (Type)null, (Type)null, "Setze ein JSON Object als JSON-Path."));
            routines.Add(new Routine(typeof(int), "json.count", (Type)null, "Anzahl Elemente (Array) / Properties (Object)."));
            routines.Add(new Routine(typeof(ScriptStack.Runtime.ArrayList), "json.keys", (Type)null, "Gibt alle Keys eines JSON-Objects als array zurück."));
            routines.Add(new Routine(typeof(bool), "json.has", (Type)null, (Type)null, "Prüft ob ein JSON-Path existiert (und nicht null ist)."));

            routines.Add(new Routine((Type)null, "json.iter", (Type)null, "Iterator für JsonObject/JsonArray (oder raw json string)."));
            routines.Add(new Routine(typeof(bool), "json.next", (Type)null, "Iterator: nächstes Element. true wenn vorhanden."));
            routines.Add(new Routine(typeof(string), "json.key", (Type)null, "Iterator: aktueller Key (Object) oder null (Array)."));
            routines.Add(new Routine(typeof(int), "json.index", (Type)null, "Iterator: aktueller Index (Array) oder -1 (Object)."));
            routines.Add(new Routine((Type)null, "json.value", (Type)null, "Iterator: aktueller Wert (primitive oder JsonNode)."));

            routines.Add(new Routine((Type)null, "json.node", (Type)null, "Konvertiert Wert/ArrayList zu JsonNode (JsonObject/JsonArray/JsonValue)."));
            routines.Add(new Routine(typeof(string), "json.string", (Type)null, "Konvertiert Wert/ArrayList zu JSON-String."));

            routines.Add(new Routine(typeof(bool), "json.is_obj", (Type)null, "True wenn Node ein JsonObject ist."));
            routines.Add(new Routine(typeof(bool), "json.is_arr", (Type)null, "True wenn Node ein JsonArray ist."));
        ...
        private sealed class JsonIterator
        {
            ...
            public void Reset()
            {
                ...
                if (_root is JsonObject obj)
                    ...
                    throw new InvalidOperationException("json.iter erwartet JsonObject oder JsonArray.");
            }
        ...
        private static object? UnboxNode(JsonNode? node)
        {
            ...
            // Objekt/Array: als JsonNode zurück (damit Script weiter json.get/json.iter nutzen kann)
            if (node is JsonObject || node is JsonArray) return node;
        ...
        private static JsonNode CoerceToNode(object? p0)
        {
            ...
            {
                var n = JsonNode.Parse(s);
                if (n is null) throw new InvalidOperationException("json.iter: Konnte JSON nicht parsen.");
                return n;
            }

            throw new InvalidOperationException("json.iter erwartet JsonNode oder JSON-String.");
        }
